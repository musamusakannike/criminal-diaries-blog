...
import { Search, Menu, X, ChevronRight, BookOpen, Clock, User, Mail } from "lucide-react"
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-gray-100">
      {/* Header */}
      <header
        className={`fixed w-full z-50 transition-all duration-300 ${scrollPosition > 50 ? "bg-black/80 backdrop-blur-md" : "bg-transparent"}`}
      >
        ...
        {isMenuOpen && (
          ...
          >
            <nav className="container mx-auto px-4 py-4 flex flex-col space-y-4">
              <Link href="#" className="text-sm font-medium hover:text-red-400 transition-colors py-2">
                Home
              </Link>
              <Link href="#" className="text-sm font-medium hover:text-red-400 transition-colors py-2">
                Stories
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <motion.h1 variants={fadeInUp} className="text-4xl md:text-6xl font-bold tracking-tight mb-6">
              Unraveling the Mysteries of <span className="text-red-500">Criminal Minds</span>
            </motion.h1>

            <motion.p variants={fadeInUp} className="text-lg md:text-xl text-gray-300 mb-8">
              Dive into the dark world of true crime with meticulously researched stories that explore the psychology
              behind notorious criminals and unsolved mysteries.
            </motion.p>

            <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button className="bg-red-600 hover:bg-red-700 text-white px-8 py-6 text-lg">Start Reading</Button>
                ...
                <Link href="#">
                  <Card className="bg-gray-800/40 backdrop-blur-md border-gray-700 overflow-hidden hover:border-red-500/50 transition-all duration-300">
                    ...
                    <CardHeader>
                      ...
                      <CardDescription className="text-gray-400">{story.excerpt}</CardDescription>
                    </CardHeader>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              Discover stories across different categories of true crime, from cold cases to serial killers and
                  ...
                  <div className="relative h-40 rounded-lg overflow-hidden group">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="text-center">
                        ...
                        <p className="text-sm text-gray-300">{category.count} Stories</p>
                      </div>
                    </div>
                  </div>
                </Link>
                  ...
                  <Card className="bg-gray-800/40 backdrop-blur-md border-gray-700 overflow-hidden hover:border-red-500/50 transition-all duration-300">
                    <div className="flex flex-col md:flex-row">
                      ...
                      <div className="w-full md:w-2/3 p-6">
                        <Badge className="mb-2 bg-gray-700 text-gray-200 hover:bg-gray-600">{post.category}</Badge>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <motion.p variants={fadeInUp} className="text-gray-300 mb-8">
              Get notified about new stories and exclusive content. We promise not to spam your inbox.
            </motion.p>
            ...
            <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              ...
              />
              <Button className="bg-red-600 hover:bg-red-700 text-white whitespace-nowrap">Subscribe</Button>
            </motion.div>
          </motion.div>
        </div>
      </section>
      ...
      <footer className="bg-black/80 backdrop-blur-md border-t border-gray-800">
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 text-sm mb-6">
                Exploring the psychology and stories behind true crime cases from around the world.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start">
                  ...
                  <span className="text-gray-400">123 Mystery Lane, Crime City, 90210</span>
                </li>
                <li>
                  <Button
                    variant="outline"
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm">© {new Date().getFullYear()} Criminal Diaries. All rights reserved.</p>
            <div className="flex space-x-6 mt-4 md:mt-0">
              <Link href="#" className="text-gray-500 hover:text-red-400 text-sm">
                Privacy Policy
              </Link>
              <Link href="#" className="text-gray-500 hover:text-red-400 text-sm">
                Terms of Service
...
const featuredStories = [
  {
    ...
    excerpt: "Explore the unsolved mystery of the Zodiac Killer who terrorized Northern California in the late 1960s.",
  ...
  },
  {
    ...
    excerpt: "The story of the largest art theft in history that remains unsolved to this day.",
    image: "/placeholder.svg?height=400&width=600",
    category: "Heists",
    readTime: "6 min read",
    author: "John Smith",
  },
  {
    ...
    excerpt: "The brutal murder of Elizabeth Short that shocked America and remains unsolved.",
    image: "/placeholder.svg?height=400&width=600",
    category: "Cold Cases",
...
const latestPosts = [
  {
    ...
    excerpt: "A deep dive into the psychological profile of one of America's most notorious serial killers.",
    image: "/placeholder.svg?height=300&width=400",
  ...
  },
  {
    ...
    excerpt: "Examining the theories and evidence surrounding one of the most high-profile missing person cases.",
    image: "/placeholder.svg?height=300&width=400",
  ...
  },
  {
    ...
    excerpt: "The story of a mysterious man who hijacked a plane, extorted $200,000, and disappeared forever.",
    image: "/placeholder.svg?height=300&width=400",
    category: "Heists",
    readTime: "7 min read",
    author: "Robert Clark",
  },
  {
    ...
    excerpt: "How advanced DNA technology finally caught a serial killer decades after his crimes.",
    image: "/placeholder.svg?height=300&width=400",
    category: "Cold Cases",
    readTime: "10 min read",
